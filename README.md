...
Normal Users – can register, log in, browse available flights, and book them.

Flight Companies – can register, log in, create new flights, and update flight prices.
